...
public class Partitioner_Geo {
    public static void main(String args[]) throws Exception {
        ...
        for(int confId =1; confId<=4; confId++) {
            ...
            DataSet<Vertex> src1 = input.getVertices().flatMap(new GetSrc("geonames"));
            DataSet<Vertex> src2 = input.getVertices().flatMap(new GetSrc("freebase"));
            DataSet<Vertex> src3 = input.getVertices().flatMap(new GetSrc("nytimes"));
            DataSet<Vertex> src4 = input.getVertices().flatMap(new GetSrc("dbpedia"));
    ...
    switch (confId) {
        ...
        case 3:
            ...
            src1 = vertices1.flatMap(new GetSrc("geonames"));
            src2 = vertices1.flatMap(new GetSrc("freebase"));
            src3 = vertices1.flatMap(new GetSrc("dbpedia"));
            src4 = vertices1.flatMap(new GetSrc("nytimes"));
