...
import org.tool.system.linking.selection.data_structures.SimilarityAggregatorRule.AggregationComponentType;
...
public class SimilarityAggregatorRule {
    ...
    public org.tool.system.linking.selection.data_structures.SimilarityAggregatorRule.SimilarityAggregatorRule toSimilarityAggregatorRule(){
        return new org.tool.system.linking.selection.data_structures.SimilarityAggregatorRule.SimilarityAggregatorRule(components, aggregationThreshold);
    }
