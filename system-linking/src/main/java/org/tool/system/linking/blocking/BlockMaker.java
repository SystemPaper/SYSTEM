package org.tool.system.linking.blocking;

import org.apache.flink.api.java.DataSet;
import org.apache.flink.api.java.tuple.Tuple2;
import org.gradoop.common.model.impl.pojo.Vertex;
import org.tool.system.linking.blocking.blocking_methods.cartesian_product.CartesianProduct;
import org.tool.system.linking.blocking.blocking_methods.data_structures.*;
import org.tool.system.linking.blocking.blocking_methods.sorted_neighborhood.SortedNeighborhood;
import org.tool.system.linking.blocking.blocking_methods.standard_blocking.StandardBlocking;
...
public class BlockMaker implements Serializable {
    ...
    public DataSet<Tuple2<Vertex,Vertex>> execute(DataSet<Vertex> vertices, Collection<SimilarityComponent> similarityComponents, String datset)  {
        ...
        switch (blockingMethod){
            ...
            case STANDARD_BLOCKING:
				try {
					return new StandardBlocking((StandardBlockingComponent) blockingComponent).execute(vertices, graphPairs, datset);
				} catch (Exception e) {
					e.printStackTrace();
				}
