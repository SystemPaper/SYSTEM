package org.tool.system.linking.blocking.key_generation;

import org.apache.flink.api.common.functions.FlatMapFunction;
import org.apache.flink.api.java.tuple.Tuple2;
import org.apache.flink.util.Collector;
import org.gradoop.common.model.impl.pojo.Vertex;
import org.tool.system.linking.blocking.key_generation.key_generation_methods.FullAttribute;
import org.tool.system.linking.blocking.key_generation.key_generation_methods.PrefixLength;
import org.tool.system.linking.blocking.key_generation.key_generation_methods.QGrams;
import org.tool.system.linking.blocking.key_generation.key_generation_methods.WordTokenizer;
...
public class BlockingKeyGenerator implements FlatMapFunction<Vertex, Tuple2<Vertex, String>> {
    ...
    private String cleanAttribueValue(String attValue){
       /*Replacing 1 or more spaces.*/
        return attValue.toString().toLowerCase().replaceAll("\\s+", " ").trim();
