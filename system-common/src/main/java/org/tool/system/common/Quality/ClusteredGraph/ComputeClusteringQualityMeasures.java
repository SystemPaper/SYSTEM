...
public class ComputeClusteringQualityMeasures {
    ...
    public void computeSets() throws Exception {
        ...
        DataSet<Tuple3<String, String, String>> verticesClusterIdsTypes = resultVertices.flatMap(new Vertex2VertexData(vertexIdLabel,"ClusterId", "graphLabel"));
...
//        System.out.println(tp+"**********eval********"+repTruePositiveNo);
    ...
    private class getSpecificPhase implements FlatMapFunction<Integer, Integer> {
