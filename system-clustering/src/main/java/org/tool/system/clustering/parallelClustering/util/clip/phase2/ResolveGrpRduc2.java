...
/**
 */
public class ResolveGrpRduc2 implements UnaryGraphToGraphOperator{
    private Double simValueCoef;
    private Double strengthCoef;
    public ResolveGrpRduc2(Double inputSimValueCoef, Double inputStrengthCoef){
...
//        input = input.callForGraph(new MyConnectedComponents(false, "ph3-"));
        return input;
    }
